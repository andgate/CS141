public class BankAccount
{
   ...
   private final static int PERCENT_FACTOR = 100;
    ...
    */
   public void addInterestYearly(double percentInterest)
   {
      double decimalRate = percentInterest / PERCENT_FACTOR; // change the rate from percent to a decimal value.
   ...
   /**
      ...
      @param rate The rate of interest, in percent.
    */
   public void addInterestMonthly(double percentInterest)
   {
      double decimalRate = percentInterest / PERCENT_FACTOR; // change the rate from percent to a decimal value.
      balance += (balance * decimalRate) / MONTHS_PER_YEAR;
   }
