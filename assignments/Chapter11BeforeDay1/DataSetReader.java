...
public class DataSetReader
{
   ...
   */
   private void readData(Scanner in) throws NoSuchElementException
   {
      if (!in.hasNextInt()) 
      {
         throw new NoSuchElementException("Length expected");
      }
      ...
      if (in.hasNext()) 
      {
         throw new NoSuchElementException("End of file expected");
      }
   }
   ...
   */
   private void readValue(Scanner in, int i) throws NoSuchElementException
   {
      if (!in.hasNextDouble()) 
      {
         throw new NoSuchElementException("Data value expected");
      }
